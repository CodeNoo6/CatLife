...
class NotificationController extends ChangeNotifier {
  ...
  static Future<void> initializeLocalNotifications({bool debug}) async {
  ...
  static Future<void> initializeRemoteNotifications({bool debug}) async {
  ...
  static Future<void> createNewNotification() async {
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            channelKey: 'alerts',
            title: '¡Vacuna con recordatorio!',
            body: "Te avisamos su próxima aplicación",
            bigPicture:
                "https://img.freepik.com/foto-gratis/veterinario-cuidando-mascota_23-2149198608.jpg",
            largeIcon: 'https://firebasestorage.googleapis.com/v0/b/catlife-ae128.appspot.com/o/ic_launcher.png?alt=media&token=f15fb990-5512-4b5c-9eae-6c0077599e53',
...
class NotificationPage extends StatelessWidget {
  const NotificationPage({key, this.receivedAction});
